// church-server/utils/ethiopianDate.js
...
const gregorianToEthiopic = (dateInput) => {
...
const ethiopicToGregorian = (year, month, day) => {
...
const formatEthiopianDate = (dateInput, format = 'long') => {
  if (!dateInput) return '—';
