...
try {
  corePersonRoutes = require('./routes/core/personRoutes');
  coreDepartmentRoutes = require('./routes/core/departmentRoutes');
  coreDepartmentMembershipRoutes = require('./routes/core/departmentMembershipRoutes');
} catch (err) {
  console.warn('⚠️ Core routes not loaded:', err.message);
}

try {
  eduStudentProfileRoutes = require('./routes/education/studentProfileRoutes');
  eduProgramRoutes = require('./routes/education/programRoutes');
  eduAcademicYearRoutes = require('./routes/education/academicYearRoutes');
  eduGradeRoutes = require('./routes/education/gradeRoutes');
} catch (err) {
  console.warn('⚠️ Education module routes not loaded:', err.message);
}
...
// --- EXISTING ROUTE MOUNTING (always works) ---
app.use('/api/auth', authRoutes);
