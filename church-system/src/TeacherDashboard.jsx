    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="p-6 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Attendance Card */}
          <div className="bg-white p-6 rounded-2xl shadow-md border-b-4 border-green-500 hover:scale-105 transition-transform cursor-pointer">
          ...
          {/* Student List Card */}
          <div className="bg-white p-6 rounded-2xl shadow-md border-b-4 border-blue-500 hover:scale-105 transition-transform cursor-pointer">
            <div className="text-3xl mb-4">👥</div>
          ...
          {/* Lessons Card */}
          <div className="bg-white p-6 rounded-2xl shadow-md border-b-4 border-orange-500 hover:scale-105 transition-transform cursor-pointer">
            <div className="text-3xl mb-4">📚</div>
