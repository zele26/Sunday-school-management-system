      ...
      <div className="min-h-[80vh] flex items-center justify-center p-4 bg-slate-50/50 font-sans">
        <div className="max-w-md w-full bg-white p-8 rounded-3xl shadow-xl border border-emerald-100 text-center animate-in zoom-in-95 duration-500">
          ...
          <div className="space-y-3">
            <Link href="/login" className="block w-full bg-blue-600 hover:bg-blue-500 text-white py-3.5 rounded-xl font-bold shadow-lg shadow-blue-600/20 transition-all">
              አሁን ይግቡ (Login)
            </Link>
            <Link href="/check-status" className="block w-full bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 py-3.5 rounded-xl font-bold transition-all">
