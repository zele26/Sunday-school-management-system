        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white p-8 sm:p-10 rounded-3xl border border-slate-100 shadow-sm">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
              ...
              <button 
                type="submit" 
                className="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-500 active:opacity-90 text-white font-semibold px-8 py-3.5 rounded-xl shadow-md shadow-emerald-600/20 transition-colors duration-150 cursor-pointer"
              >
                መልእክት ላክ
              </button>
            </form>
