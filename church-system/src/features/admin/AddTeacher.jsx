...
import { UserPlus, ArrowLeft, Save, User, Mail, Lock, Phone, MapPin, BookOpen, GraduationCap, AlertTriangle, Calendar, Search } from 'lucide-react';
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card variant="default" padding="lg" className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-1.5">ስልክ ቁጥር (10 አሃዝ) *</label>
              <Input icon={Phone} name="phone" required placeholder="09XXXXXXXX" value={form.phone} onChange={handleChange} />
            </div>
          </div>
            ...
            <div className="space-y-4 pt-3 border-t border-slate-100 dark:border-slate-800">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                <div>
                  ...
                  <p className="text-[11px] text-slate-400">መምህሩ የሚያስተምሯቸውን ኮርሶች ይምረጡ</p>
                </div>
              </div>
