...
//   const handleLogout = () => {
//     if (onLogout) {
//       onLogout(); // Triggers App.jsx handleLogout (clears localStorage & updates isLoggedIn state)
//     } else {
//       localStorage.clear();
//     }
//     navigate('/'); // Redirects to '/' where your Login route lives
//   };
...
//           className="bg-white text-blue-600 px-4 py-2 rounded-xl font-semibold hover:bg-blue-50 transition-colors shadow-sm"
//         >
//           Logout
//         </button>
//       </header>
...
const AdminLayout = ({ onLogout }) => {
  ...
  const handleLogout = () => {
    // 1. Clear authentication state in App.jsx and localStorage
    if (onLogout) {
      onLogout();
    } else {
      localStorage.clear();
    ...
    // 2. Redirect back to login page cleanly
