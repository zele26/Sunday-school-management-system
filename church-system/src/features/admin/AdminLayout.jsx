...
const allNavSections = [
  {
    ...
    items: [
      ...
      { path: '/admin/student-profiles', labelKey: 'navStudentProfiles', label: 'የተማሪዎች ፕሮፋይል', icon: GraduationCap, permission: PERMISSIONS.STUDENTS_VIEW },
      ...
      { path: '/admin/classes', labelKey: 'navClasses', label: 'ክፍሎችና ባቾች', icon: School, permission: PERMISSIONS.ACADEMIC_CLASSES },
