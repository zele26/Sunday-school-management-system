          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start pt-2">
              <Link
                ...
                className="px-8 py-4 bg-gradient-to-r from-amber-400 to-yellow-500 hover:from-amber-300 hover:to-yellow-400 text-slate-950 font-black rounded-2xl shadow-xl shadow-amber-500/25 transition-all transform hover:-translate-y-0.5 text-base flex items-center gap-2.5"
              >
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div
              key={idx}
              className="bg-white rounded-3xl p-6 border border-slate-100 shadow-xl shadow-slate-200/40 hover:-translate-y-1 transition-all space-y-4 relative overflow-hidden group"
            >
      ...
      <section className="py-16 bg-gradient-to-r from-blue-900 via-indigo-900 to-slate-950 text-white text-center px-4 sm:px-6">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="flex flex-wrap gap-4 justify-center pt-2">
            <Link
              to="/register-distance"
              className="px-8 py-4 bg-amber-400 hover:bg-amber-300 text-slate-950 font-black rounded-2xl shadow-xl shadow-amber-400/20 transition-transform transform hover:-translate-y-0.5 text-base"
            >
