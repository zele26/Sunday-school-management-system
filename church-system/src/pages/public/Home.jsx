  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans antialiased text-slate-800 selection:bg-amber-500 selection:text-slate-950">
      ...
      <section 
        ...
        style={{ backgroundImage: `url(${bgImage})` }}
      >
        {/* Radial Gradient Overlay: Light/transparent in the center, intense dark blue at the corners */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-blue-900/10 via-blue-950/80 to-slate-950" />

        <div className="relative z-10 max-w-4xl mx-auto text-center text-white space-y-8">
          {/* Welcome Badge */}
          <span className="inline-flex items-center gap-2 bg-amber-500/15 text-amber-400 border border-amber-500/30 text-xs sm:text-sm font-semibold px-5 py-2 rounded-full backdrop-blur-md shadow-lg shadow-amber-500/10 tracking-wide">
            <span className="w-2 h-2 rounded-full bg-amber-400 animate-pulse"></span>
            እንኳን ደህና መጡ!
          </span>
          ...
          <p className="max-w-2xl mx-auto text-base md:text-lg text-slate-200 font-light leading-relaxed">
            የሕፃናትና ወጣቶች መንፈሳዊ ትምህርት ማዕከል — በሃይማኖትና በምግባር የታነጸ ትውልድ እንገነባለን።
          </p>

          <div className="pt-6 flex flex-col sm:flex-row justify-center items-center gap-4">
            {/* Register button – Pill shaped, solid amber/gold to match reference */}
            <button
              onClick={() => setShowRegOptions(true)}
              className="w-full sm:w-auto bg-amber-500 hover:bg-amber-400 text-slate-950 px-10 py-3.5 rounded-full font-bold shadow-lg shadow-amber-500/20 transition-all duration-300 transform hover:-translate-y-1 active:translate-y-0"
            >
              ይመዝገቡ
            </button>

            {/* Login button – Pill shaped, dark translucent blue with subtle border */}
            <Link 
              to="/login" 
              className="w-full sm:w-auto bg-blue-950/50 hover:bg-blue-900/70 border border-slate-400/30 backdrop-blur-md text-white px-10 py-3.5 rounded-full font-semibold shadow-lg transition-all duration-300 transform hover:-translate-y-1 active:translate-y-0"
            >
              ይግቡ
            </Link>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-sm w-full text-center border border-slate-100 space-y-4">
            ...
            <div className="space-y-3 pt-2">
              <Link
                to="/register-regular"
                onClick={() => setShowRegOptions(false)}
                className="block w-full bg-gradient-to-r from-blue-700 to-indigo-700 hover:from-blue-800 hover:to-indigo-800 text-white py-3.5 rounded-full font-bold shadow-md shadow-blue-900/20 transition-all"
              >
                መደበኛ (Regular)
              </Link>
              ...
              <Link
                to="/register-distance"
                onClick={() => setShowRegOptions(false)}
                className="block w-full bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-600 hover:to-yellow-600 text-slate-950 py-3.5 rounded-full font-bold shadow-md shadow-amber-500/20 transition-all"
              >
                ርቀት (Distance)
              </Link>
            </div>
