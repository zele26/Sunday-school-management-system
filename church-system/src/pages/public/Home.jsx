    ...
    <div className="min-h-screen bg-slate-50 font-sans antialiased text-slate-800 selection:bg-amber-400 selection:text-slate-950">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center text-white space-y-7">
          ...
          <div className="pt-2 flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <button
              ...
              className="w-full sm:w-auto bg-gradient-to-r from-amber-400 to-yellow-500 hover:from-amber-300 hover:to-yellow-400 text-slate-950 px-9 py-4 rounded-2xl font-black shadow-xl shadow-amber-400/25 transition-all duration-300 transform hover:-translate-y-0.5 active:translate-y-0 text-base"
            >
              ይመዝገቡ (Register Now) ➔
            </button>
            ...
            <Link
              ...
              className="w-full sm:w-auto bg-blue-600/30 hover:bg-blue-600/50 border border-blue-400/40 backdrop-blur-xl text-white px-8 py-4 rounded-2xl font-bold shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 text-base flex items-center justify-center gap-2"
            >
            ...
            <Link
              to="/login"
              className="w-full sm:w-auto bg-white/10 hover:bg-white/20 border border-white/20 backdrop-blur-xl text-white px-8 py-4 rounded-2xl font-bold shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 text-base"
            >
              ይግቡ (Sign In) 🔐
            </Link>
          </div>
      ...
      <section className="py-24 max-w-6xl mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8">
          {/* Vision */}
          <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:border-amber-400/40 transition-all duration-300 transform hover:-translate-y-1.5 text-center group">
