...
//               <strong className="font-bold mx-1 text-amber-900">"ምዝገባዎን ይቀጥሉ"</strong> 
//               የሚለውን ይጫኑ።
//             </span>
//           </p>
//         </div>
    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center p-4 bg-slate-50/50 font-sans">
        <div className="max-w-lg w-full bg-white p-8 rounded-3xl shadow-xl border border-blue-100 text-center animate-in zoom-in-95 duration-500">
          ...
          {/* ✅ Application Number Card (instead of School ID) */}
          <div className="bg-blue-50 rounded-2xl p-5 border border-blue-200 mb-8">
            <p className="text-xs font-semibold text-blue-600 uppercase tracking-wider mb-1">የማመልከቻ ቁጥር (Application Number)</p>
            <p className="text-3xl font-black text-blue-700 tracking-widest">{result?.registrationNumber}</p>
            <p className="text-sm text-blue-600 mt-3">
              📌 ምዝገባዎ ሲጸድቅ ትክክለኛውን የትምህርት ቤት መለያ (School ID) ያገኛሉ።
            </p>
          </div>
