...
const RegisterDistance = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: '', password: '', studentType: 'distance',
  });
  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4">
      <h1 className="text-3xl font-bold text-slate-800 mb-6 text-center">የርቀት ተማሪ ምዝገባ</h1>
